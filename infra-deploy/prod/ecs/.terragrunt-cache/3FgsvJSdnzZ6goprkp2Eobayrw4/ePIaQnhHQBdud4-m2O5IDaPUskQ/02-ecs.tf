...
resource "aws_ecs_task_definition" "this" {
  ...
  container_definitions = jsonencode([
    {
      name      = "rails-bank-trx-reporting-sidekiq-latest"
      image     = "891377081827.dkr.ecr.ca-central-1.amazonaws.com/ecr-rails-bank-trx-reporting:rails-bank-trx-reporting-sidekiq-latest-9e3b826"
      cpu       = 256
      memory    = 512
      essential = true
      portMappings = [
    ...
    {
      name      = "rails-bank-trx-reporting-rails"
      image     = "891377081827.dkr.ecr.ca-central-1.amazonaws.com/ecr-rails-bank-trx-reporting:rails-bank-trx-reporting-rails-latest-9e3b826"
      cpu       = 256
      memory    = 512
      essential = true
      portMappings = [
...
resource "aws_ecs_service" "this" {
  ...
  # load_balancer {
  #   target_group_arn = var.aws_ecs_service_load_balancer
